...
public class AddressBookMain {
	...
	public void CountTotalStates(String state)
	{
		int countState=0;
		for (String key1 : addressBookListMap.keySet()) {
			HashMap<String, ContactDetails> contactListMap = addressBookListMap.get(key1);
		...
		System.out.println("Total Count of the people in the state : "+countState);
	}

	public void CountTotalCity(String city)
	{
		int countCity=0;
		for (String key1 : addressBookListMap.keySet()) {
			HashMap<String, ContactDetails> contactListMap = addressBookListMap.get(key1);
			for (String key2 : contactListMap.keySet()) {
				...
				if (city.equals(cd.getState())) {
					countCity++;
				}

			}
		}
		System.out.println("Total Count of the people in the city : "+countCity);
	}
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 6: {
				System.out.println("Enter Name of State: ");
				String StateName = sc.next();
				addressBookMain.CountTotalStates(StateName);
				break;
			}
			case 7:{
				System.out.println("Enter Name of City: ");
				String CityName = sc.next();
				addressBookMain.CountTotalCity(CityName);
				break;
			}
			case 8:
				System.out.println("Exit");
